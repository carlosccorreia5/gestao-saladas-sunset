    ...
    try {
      ...
      const { data: shipment, error: shipmentError } = await supabase
        ...
        .insert({
          ...
          notes: 'Pedido automático da loja',
          created_by: userDbId,
      ...
      alert(`✅ Pedido ${shipmentNumber} enviado com sucesso! A produção já foi notificada.`);
        ...
        <div style={{
          ...
          >
            ...
            <p style={{ color: '#666', fontSize: '16px', lineHeight: '1.5', marginBottom: '25px' }}>
              Faça pedidos de saladas para produção. Escolha os tipos e quantidades.
            </p>
            <div style={{
              padding: '12px 25px',
